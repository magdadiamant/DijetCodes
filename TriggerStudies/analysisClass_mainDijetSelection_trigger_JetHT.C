...
void analysisClass::Loop()
{
  ...
  char* HLTname[50]    = {"noTrig","PFHT1050","PFJet550","Mu50", "AK8PFJet550","CaloJet550","AllJet"};
   ...
   TH1F* h_mjj_HLTpass_dR2[50];
   TH1F* h_mjj_HLTpass_dR2_bb[50];
...
char name_histoHLT_dR2_alpha1[50];
   TH1F* h_mjj_HLTpass_dR2_alpha1[50];
   TH1F* h_mjj_HLTpass_dR2_alpha1_bb[50];
 char name_histoHLT_dR2_alpha1_bb[50];

char name_histoHLT_dR2_alpha2[50];
   TH1F* h_mjj_HLTpass_dR2_alpha2[50];
   TH1F* h_mjj_HLTpass_dR2_alpha2_bb[50];
 char name_histoHLT_dR2_alpha2_bb[50];


char name_histoHLT_dR2_alpha3[50];
TH1F* h_mjj_HLTpass_dR2_alpha3[50];
   TH1F* h_mjj_HLTpass_dR2_alpha3_bb[50];
 char name_histoHLT_dR2_alpha3_bb[50];


char name_histoHLT_dR2_alpha4[50];
   TH1F* h_mjj_HLTpass_dR2_alpha4[50];
   TH1F* h_mjj_HLTpass_dR2_alpha4_bb[50];
 char name_histoHLT_dR2_alpha4_bb[50];

char name_histoHLT_dR2_alpha5[50];
   TH1F* h_mjj_HLTpass_dR2_alpha5[50];
   TH1F* h_mjj_HLTpass_dR2_alpha5_bb[50];
 char name_histoHLT_dR2_alpha5_bb[50];


char name_histoHLT_dR2_alpha6[50];
   TH1F* h_mjj_HLTpass_dR2_alpha6[50];
   TH1F* h_mjj_HLTpass_dR2_alpha6_bb[50];
 char name_histoHLT_dR2_alpha6_bb[50];


char name_histoHLT_dR2_alpha7[50];
   TH1F* h_mjj_HLTpass_dR2_alpha7[50];
   TH1F* h_mjj_HLTpass_dR2_alpha7_bb[50];
 char name_histoHLT_dR2_alpha7_bb[50];


char name_histoHLT_dR2_alpha8[50];
   TH1F* h_mjj_HLTpass_dR2_alpha8[50];
   TH1F* h_mjj_HLTpass_dR2_alpha8_bb[50];
 char name_histoHLT_dR2_alpha8_bb[50];


char name_histoHLT_dR2_alpha9[50];
   TH1F* h_mjj_HLTpass_dR2_alpha9[50];
   TH1F* h_mjj_HLTpass_dR2_alpha9_bb[50];
 char name_histoHLT_dR2_alpha9_bb[50];


char name_histoHLT_dR2_alpha10[50];
   TH1F* h_mjj_HLTpass_dR2_alpha10[50];
   TH1F* h_mjj_HLTpass_dR2_alpha10_bb[50];
 char name_histoHLT_dR2_alpha10_bb[50];


char name_histoHLT_dR2_alpha11[50];
   TH1F* h_mjj_HLTpass_dR2_alpha11[50];
   TH1F* h_mjj_HLTpass_dR2_alpha11_bb[50];
...
char name_histoHLT_dR2_alpha12[50];
   TH1F* h_mjj_HLTpass_dR2_alpha12[50];
   TH1F* h_mjj_HLTpass_dR2_alpha12_bb[50];
 char name_histoHLT_dR2_alpha12_bb[50];


char name_histoHLT_dR2_alpha13[50];
   TH1F* h_mjj_HLTpass_dR2_alpha13[50];
   TH1F* h_mjj_HLTpass_dR2_alpha13_bb[50];
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha1[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha1[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha1[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha1[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha1[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha2[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha2[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha2[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha2[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha2[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha3[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha3[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha3[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha3[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha3[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha4[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha4[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha4[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha4[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha4[5] -> Fill(M4J_AK4);
if ( (triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) ||
       triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ||
triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second))
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha5[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha5[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha5[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha5[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha5[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha6[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha6[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha6[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha6[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha6[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha7[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha7[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha7[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha7[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha7[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha8[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha8[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha8[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha8[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha8[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha9[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha9[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha9[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha9[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha9[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha10[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha10[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha10[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha10[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha10[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha11[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha11[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha11[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha11[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha11[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha12[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha12[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha12[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha12[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha12[5] -> Fill(M4J_AK4);
...
if(triggerResult->at(triggerMap_.find("HLT_PFHT1050_v*")->second) ) h_mjj_HLTpass_dR2_alpha13[1] -> Fill(M4J_AK4);


if(triggerResult->at(triggerMap_.find("HLT_PFJet550_v*")->second)  ) h_mjj_HLTpass_dR2_alpha13[2] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_Mu50_v*")->second)) h_mjj_HLTpass_dR2_alpha13[3] -> Fill(M4J_AK4);

if(triggerResult->at(triggerMap_.find("HLT_AK8PFJet550_v*")->second) ) h_mjj_HLTpass_dR2_alpha13[4] -> Fill(M4J_AK4);
if(triggerResult->at(triggerMap_.find("HLT_CaloJet550_NoJetID_v*")->second) ) h_mjj_HLTpass_dR2_alpha13[5] -> Fill(M4J_AK4);
